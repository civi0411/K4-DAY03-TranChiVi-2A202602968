...
class MockOfflineProvider(BaseLLMProvider):
  ...
  def generate_with_tools(self, prompt: str, tools_schema: List[Dict[str, Any]], system_prompt: str = "") -> Dict[str, Any]:
    ...
    if "xyz99" in prompt_lower:
      if "không tìm thấy" in prompt_lower or "quan sát" in prompt_lower:
        return {
          "type": "text",
          "content": "[Mock] Mã chứng khoán XYZ99 không tồn tại trên hệ thống. Bạn vui lòng kiểm tra lại.",
          "thought": "Đã nhận thông báo mã không tồn tại, trả lời người dùng."
        }
      return {
        "type": "tool_call",
      ...
      if "thành công" in prompt_lower or "đã khớp lệnh" in prompt_lower or "quan sát" in prompt_lower:
        return {
          "type": "text",
          "content": "[Mock] Lệnh mua 1000 cổ phiếu VCB đã được thực hiện thành công.",
          "thought": "Đã nhận kết quả thực thi lệnh, thông báo cho người dùng."
        }
      return {
        "type": "tool_call",
      ...
      if "thành công" in prompt_lower or "đã khớp lệnh" in prompt_lower:
        return {
          "type": "text",
          "content": "[Mock] Lệnh mua 500 cổ phiếu FPT đã được thực hiện thành công theo yêu cầu.",
          "thought": "Đã thực hiện lệnh xong, thông báo cho người dùng."
        }
      elif "quan sát" not in prompt_lower:
         return {
          "type": "tool_call",
          "tool_name": "analyze_stock_ticker",
      ...
      if "quan sát" in prompt_lower:
        return {
          "type": "text",
          "content": "[Mock] Theo quan sát, thông tin mã cổ phiếu FPT đã được hiển thị.",
          "thought": "Đã có dữ liệu từ tool, trả lời cho người dùng."
        }
      return {
        "type": "tool_call",
        "tool_name": "analyze_stock_ticker",
